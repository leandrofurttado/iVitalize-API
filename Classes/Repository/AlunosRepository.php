...
class AlunosRepository
{
    ...
    /*     public function insertAluno($username, $password, $email, $nivel_auth)
    {
    ...
    public function insertAluno($data)
    {
        try {
            ...
            $query = 'INSERT INTO ' . self::TABELA . " ($columns) VALUES ($values)";
            ...
            // Verifica se o erro é relacionado à violação de chave UNIQUE (cpf duplicado)
            if ($e->getCode() == '23000') {
                throw new \Exception("CPF já cadastrado! Não é possível matricular este aluno!", 409); // 409: Conflito
            } else {
                // Lança a exceção original se não for relacionada ao CPF duplicado
                throw $e;
            }
        }
    }
